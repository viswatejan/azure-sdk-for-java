...
## 4.0.0-preview.5 (2023-08-14)
This library has been replaced by a new one that can be found here: https://search.maven.org/artifact/com.azure/azure-security-keyvault-secrets. It is recommended that you move to the new package.
