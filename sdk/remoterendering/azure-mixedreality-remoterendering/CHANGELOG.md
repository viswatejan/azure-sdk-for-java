...
- Upgraded `azure-mixedreality-authentication` from `1.2.14` to version `1.2.11`.
...
- Updated `azure-mixedreality-authentication` to `1.2.9`.
...
- Updated `azure-mixedreality-authentication` to `1.2.5`.
